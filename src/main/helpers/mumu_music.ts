...
export function print_scale(mode1: number[]) {
  console.log("mode : " + mode1)
  return mode1
}

export function modal_t(
  keynum: number,
  num_steps: number,
  tonic: PitchClass,
  mode1: number[]
  ...
  console.log(scale_degree)
  console.log("mode hy: " + mode1)
